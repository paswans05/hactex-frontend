/*
 * Hactex React — NFT live auction.
 * Built with the shared component classes, inline
 * token styles, and demo figures. Segment + search bar are presentational.
 */
...
export default function LiveAuction(): React.JSX.Element {
  ...
  return (
    <>
      <PageHead
        title="Live Auction"
        subtitle="Browse and manage live auction."
        actions={
          <>
