...
export default function Reports(): React.JSX.Element {
  ...
  return (
    <>
      <PageHead
        title="Reports"
        subtitle="Browse and manage reports."
        actions={
          <>
              ...
              <tbody>
                {REPORTS.map((r) => (
                  <tr key={r.name}>
                    <td>
                      <div className="at-cluster">
                        <div
                          ...
                          style={{
                            ...(r.bg ? { background: r.bg, color: r.color } : null),
                    ...
                    <td><span className={`at-badge at-badge--${r.statusKind}`}>{r.status}</span></td>
                  </tr>
                ))}
              </tbody>
            </table>
