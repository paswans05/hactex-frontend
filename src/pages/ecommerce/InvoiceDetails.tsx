/*
 * Hactex React — eCommerce Invoice Details.
...
export default function InvoiceDetails(): React.JSX.Element {
  ...
  return (
    <>
      <PageHead
        ...
        subtitle="Details for this invoice details."
        actions={
          <>
        ...
        <div className="at-card" style={{ padding: 'var(--at-space-5)' }}>
          <div className="at-cluster" style={{ justifyContent: 'space-between' }}>
            <div className="at-cluster">
              ...
              <div>
                <h2 className="at-chart__title">Invoice Details</h2>
