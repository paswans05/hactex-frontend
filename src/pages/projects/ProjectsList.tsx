/*
 * Hactex React — Projects list.
 * Built with the shared component classes,
 * inline token styles, and demo figures. Segment + search bar are
 * presentational.
 */
...
export default function ProjectsList(): React.JSX.Element {
  ...
  return (
    <>
      <PageHead
        title="Projects List"
        subtitle="Browse and manage projects list."
        actions={
          <>
      ...
      <div className="at-stack" style={{ gap: 'var(--at-space-5)' }}>
        <div className="at-card at-cluster" style={{ padding: 'var(--at-space-5)' }}>
          <div className="at-search" style={{ flex: '1 1 240px', boxShadow: 'none' }}>
            ...
            <span>Search projects list…</span>
          </div>
